...
for fraction in FEATURE_FRACTIONS:
    ...
    # SGDClassifier probabilities can contain NaN/Inf due to score overflow.
    # Apply softmax on the raw decision scores instead for guaranteed valid probs.
    ...
    # ROC-AUC: OVR macro for multiclass, standard for binary
    if is_multiclass:
